...
function getPostContentDe(post, turndownService, config) {
  const postmeta = post.postmeta.find(postmeta => postmeta.meta_key[0] === '_de_post_content');
  let content = postmeta ? postmeta.meta_value[0] : '';
...
exports.getPostContentDe = getPostContentDe;